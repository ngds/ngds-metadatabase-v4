...
--
-- Name: reclinkarchive; Type: TABLE; Schema: public; Owner: ngdsdb
--

CREATE TABLE public.reclinkarchive (
    identifier text NOT NULL,
    links text
);


ALTER TABLE public.reclinkarchive OWNER TO ngdsdb;
...
--
-- Name: reclinkarchive reclinkarc_pkey; Type: CONSTRAINT; Schema: public; Owner: ngdsdb
--

ALTER TABLE ONLY public.reclinkarchive
    ADD CONSTRAINT reclinkarc_pkey PRIMARY KEY (identifier);
...
--
-- Name: TABLE reclinkarchive; Type: ACL; Schema: public; Owner: ngdsdb
--

GRANT SELECT,INSERT,REFERENCES,DELETE,TRUNCATE,UPDATE ON TABLE public.reclinkarchive TO py_fdw;
